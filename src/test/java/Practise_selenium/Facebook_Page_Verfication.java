...
public class Facebook_Page_Verfication {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Facebook_Page_Verfication page = new Facebook_Page_Verfication();
		page.browserlaunch_method();
		page.titel_verfication_page();
		page.teardown_method();
